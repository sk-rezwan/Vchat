<template>
  <div class="container">
<h3 class=" text-center">Vchat Messaging App</h3>
<div class="messaging">
      <div class="inbox_msg">
...
export default {
  ...
  methods:{
      saveMessage(){
          ...
          db.collection("chat").add({
            ...
            author:this.authUser.displayName, //display user name
            createdAt: new Date()
        })
        this.message = null //clear the window
      },
      fetchMessages(){
  ...
  created(){
        firebase.auth().onAuthStateChanged(user=>{
          if(user){
            this.authUser=user; //show user name
          }else{
            this.authUser={}
          }
        })
